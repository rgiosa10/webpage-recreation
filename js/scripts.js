...
window.addEventListener("load", function () {
  ...
  form.addEventListener("submit", function(event) {
    ...
    const input3Value = parseInt(document.getElementById("input3").value);

    const array = [input1Value, input2Value, input3Value];
    ...
    array.forEach(function(element) {
      ...
      liAdd.append(element);
      ulElement1.append(liAdd);
    })
